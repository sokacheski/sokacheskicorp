...
export default function ReorderSection({
  ...
  useEffect(() => {
    ...
    } else if (open && (!sections || sections.length === 0)) {
      setItems([]);
    }
  }, [open, sections]);
  ...
  const handleSave = async () => {
    try {
      ...
      await api.post("/sections/reorder", { orderedIds });
            ...
            <div className="px-8 py-6 bg-[#1A212F] border-b border-gray-800 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">
                  Arraste para ordenar as seções como preferir
                </p>
              </div>
              <button
                onClick={onClose}
                          ...
                          >
                            {(provided, snapshot) => (
                              ...
                              >
                                ...
                                {/* APENAS O TÍTULO DA SEÇÃO - SEM BADGE DE LAYOUT */}
