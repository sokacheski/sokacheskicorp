...
import { FiType, FiLayout, FiX } from "react-icons/fi";
            ...
            <div className="px-8 py-6 bg-[#1A212F] border-b border-gray-800 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">
                  {isEdit
                    ? "Altere as informações da seção"
                    : "Configure a nova seção que será exibida na vitrine"}
                </p>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="px-8 py-5 bg-[#1A212F] border-t border-gray-800 flex items-center justify-end gap-4">
              ...
              >
                {loading ? (
                  ...
                  <span>{isEdit ? "Salvar alterações" : "Criar seção"}</span>
                )}
              </button>
            </div>
          </div>
